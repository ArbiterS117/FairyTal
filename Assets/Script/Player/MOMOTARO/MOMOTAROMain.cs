...
public class MOMOTAROMain : MonoBehaviour {

    GameCtrl gameCtrl;
	MOMOTAROSpecialAction playerCtrl;
    ...
    void Awake() {
        ...
        playerCtrl = GetComponent<MOMOTAROSpecialAction>();
	}
        ...
        if (inputEnabled) {
            ...
            if (inputDelay)
            {
                ...
                if (Input.GetButtonDown(playerULTString) && !playerCtrl.DownState && !playerCtrl.UpState)
                {
                    ...
                    {
                        if (!ULT1Ready) playerCtrl.actionSPAttack5();
                        else playerCtrl.actionULT1();
                ...
                {
                    if (!ULT1Ready || playerCtrl.isInCombo) playerCtrl.actionSPAttack1();
                    else playerCtrl.actionULT1();
