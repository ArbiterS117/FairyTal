...
public class SNOWWHITEAIPlayerCtrl : AIPlayerBase {
    SNOWWHITESpecialAction playerSpecial;

    public override void Awake()
    {
        base.Awake();
        playerSpecial = GetComponent<SNOWWHITESpecialAction>();
    }
    ...
    public override void BacktoMapMid()
    {
        ...
        if (BackAirJumpColdCTime >= BackAirJumpColdTime)
        {
            ...
            else playerSpecial.actionSPAttackMushroomJump();
            BackAirJumpColdCTime = 0.0f;
        }
    }
    #endregion
    ...
    public override void FollowPokeAttatk()
    {
        ...
        if (FollowAttackColdCTime >= FollowAttackColdTime)
        {
            ...
            if (randomNUM < 1.0f)
            {
                if (playerCtrl.MP >= playerSpecial.AppleMineMP) playerSpecial.actionSPAttack2();
            }
