...
public class REDAIPlayerCtrl : AIPlayerBase {

    REDSpecialAction playerSpecial;

    public override void Awake()
    {
        base.Awake();
        playerSpecial = GetComponent<REDSpecialAction>();
    }
    ...
    public override void BacktoMapMid()
    {
        ...
        if (BackAirJumpColdCTime >= BackAirJumpColdTime)
        {
            ...
            else  playerSpecial.actionSPAttack2();
          BackAirJumpColdCTime = 0.0f;
        }
    }
    #endregion
    ...
    public override void FollowPokeAttatk()
    {
        ...
        if (FollowAttackColdCTime >= FollowAttackColdTime)
        {
            ...
            if (randomNUM < 1.0f)
            {
                if (playerCtrl.MP >= playerSpecial.BasketStrikeMP) playerSpecial.actionSPAttack3();
            }
        }
    }
    #endregion
